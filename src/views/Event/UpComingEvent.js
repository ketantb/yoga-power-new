        ...
        <CCard>
            <CCardHeader>
                <CRow>
                    ...
                    <CCol>
                        <CCardTitle className='mt-2'>Navratri Pass <CBadge color="primary float-end">Upcoming</CBadge></CCardTitle>
...
</CCol><CCol  lg={6} md={8}  className=' mb-3 d-flex flex-column align-items-center ' >
        <CCard>
            <CCardHeader>
                <CRow>
                    <CCol xs={4}>
