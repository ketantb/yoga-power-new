...
const PtClasses = () => {
    ...
    const [ptMonthLyReportData,setPtMonthLeyReport] = useState([])
    ...
    const  getPtClasses = useCallback(async function() {
      ...
      useEffect(()=>{
        const newDate =  getDaysInMonth(+selectedMonth,+selectedYear)
            ...
            setPtMonthLeyReport(ptMonthLyReport(clientAttendance2.filter((el)=>el.category==="PT Classes"),memBerData2))
