...
.map((el2,i)=>{
    ...
    leadAssign+=el2.TotalLeadCoverted
    totalAmount+=el2.Balance_Collection
    totalLeadCoverted+=el2.TotalLeadCoverted
...
<CTableRow className='text-center' >
                    ...
                    <CTableDataCell  className=' border border-2  border-dark text-dark'>{percentage(totalLeadCoverted,totalTarget).toFixed(2)}%</CTableDataCell>  
                </CTableRow>  
            </CTableBody>
        </CTable>
        {!leadTargetData[0] ?
