...
const selectedStaff = staff.find((el)=>el._id===ser5)
    ...
    const saveInvoice = () => {
        ...
        let data = {
            ...
            callTimeing:'No call timeing yet',
            discussion:'No call discussion yet',
            contact:ContactNumber,
            package:serviceVaration,
            followupby:'No one available  yet',
                                ...
                                <CRow>
                                    ...
                                    <CCol className='mt-2' style={{ marginRight: '30px' }}>
                                        <div className='float-end'>
                                            ...
                                            Counseller : {selectedStaff?.FullName}
                                        </div>
                                    </CCol>
                                        ...
                                        <CTableRow>
                                            ...
                                            <CTableDataCell>
                                                <CRow>
                                                    ...
                                                    <CCol lg={12}>
                                                        <div style={{ fontWeight: 'bold' }}>Package Name: {ser6}</div>
